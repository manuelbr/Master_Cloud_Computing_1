 ...
 */
public class FactoriaTristeza implements FactoriaEmocion  {
    protected String tipoCuestionario;
    protected int preguntaActual;

    public FactoriaTristeza(String Cuestionario, int pregActual){
        tipoCuestionario = Cuestionario;
        preguntaActual = pregActual;
    }

    public Emocion creaObjeto(ArrayList<String> tiposYaIncluidos){
        return new Tristeza(tipoCuestionario,preguntaActual,tiposYaIncluidos);
    }
}
